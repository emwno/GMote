package com.aashir.gmote.ui.widget;
...
public class Switch extends CompoundButton {
    ...
    public Switch(Context context, AttributeSet attrs, int defStyle) {
        ...
        mSwitchWidth = 165;
        mSwitchHeight = 96;
        mTrackColor = Color.parseColor("#4f4f4f");
        mTrackCheckedColor = Color.parseColor("#E8F3FC");
        mThumbColor = Color.parseColor("#E8F3FC");
        mThumbCheckedColor = Color.parseColor("#E8F3FC");
        mSwitchThumbRadius = 15;
        mSwitchRippleMaxRadius = 36;
        mStrokeWidth = 6;
        mTrackWidth = 6;
    }
